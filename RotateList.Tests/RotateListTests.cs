...
public class RotateListTests
{
    ...
    [Fact]
    public void OneRotation_Rotate_FirstShouldBeLast()
    {
        List<int> result = [0, 1, 2, 3, 4, 5, 6];
        int start = result[0];
    ...
    [Fact]
    public void OneNegativeRotation_Rotate_EndShouldBeFirst()
    {
        List<int> result = [0, 1, 2, 3, 4, 5, 6];
        int tail = result[^1];
    ...
    {
        yield return new object[] { new List<int> { 3, 4, 5, 6, 1, 2 }, new List<int> { 1, 2, 3, 4, 5, 6 }, 2 };
